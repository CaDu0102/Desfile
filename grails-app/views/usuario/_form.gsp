...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'senha', 'error')} required">
	...
	<g:textField name="senha" maxlength="45" required="" value="${usuarioInstance?.senha}"/>
...
<div class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'funcoes', 'error')} ">
	<label for="funcoes">
		<g:message code="usuario.funcoes.label" default="Funcoes" />
		
	</label>
	<g:select name="funcoes" from="${desfile.Funcao.list()}" multiple="multiple" optionKey="id" size="5" value="${usuarioInstance?.funcoes*.id}" class="many-to-many"/>
