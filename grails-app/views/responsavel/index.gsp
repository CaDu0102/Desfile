		...
		<div id="list-responsavel" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="responsavel.idEscola.label" default="Id Escola" /></th>
				...
				<g:each in="${responsavelInstanceList}" status="i" var="responsavelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${responsavelInstance.id}">${fieldValue(bean: responsavelInstance, field: "idEscola")}</g:link></td>
					
						<td><g:formatDate date="${responsavelInstance.inicioPeriodo}" /></td>
