	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="casado-label" class="property-label"><g:message code="usuario.casado.label" default="Casado" /></span>
					
						<span class="property-value" aria-labelledby="casado-label"><g:formatBoolean boolean="${usuarioInstance?.casado}" /></span>
				...
				<g:if test="${usuarioInstance?.funcoes}">
				<li class="fieldcontain">
					<span id="funcoes-label" class="property-label"><g:message code="usuario.funcoes.label" default="Funcoes" /></span>
					
						<g:each in="${usuarioInstance.funcoes}" var="f">
						<span class="property-value" aria-labelledby="funcoes-label"><g:link controller="funcao" action="show" id="${f.id}">${f?.encodeAsHTML()}</g:link></span>
						</g:each>
