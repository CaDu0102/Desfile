	...
	<body>
		...
		<div id="show-integrante" class="content scaffold-show" role="main">
			...
			<ol class="property-list integrante">
				...
				<g:if test="${integranteInstance?.escolas}">
				<li class="fieldcontain">
					<span id="escolas-label" class="property-label"><g:message code="integrante.escolas.label" default="Escolas" /></span>
					
						<g:each in="${integranteInstance.escolas}" var="e">
